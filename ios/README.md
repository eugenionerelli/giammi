...
1. Xcode → New Project → iOS → App. Interface: **SwiftUI**, Language: **Swift**. Nome: `Giammi`.
2. Sostituisci il file `GiammiApp.swift` generato con quello in questa cartella.
...
5. Avvia il server sul Mac (apri `Giammi.app` o `uvicorn`), poi Run su iPhone (stessa Wi-Fi).
